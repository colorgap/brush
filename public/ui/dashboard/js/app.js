        ...
        function($stateProvider, $urlRouterProvider, localStorageServiceProvider,$httpProvider) {
            $stateProvider
                ...
                .state('resetForgotPassword', {
                    ...
                    templateUrl: 'ui/dashboard/partials/resetForgotPassword/resetForgotPassword.html',
                ...
                .state('dashboard', {
                    url: '/',
                    templateUrl: 'ui/dashboard/partials/dashboard/dashboard.html',
...
(function() {
    'use strict';
    app.controller('forgotPasswordCtrl', ['api','url','constants',
...
(function() {
    'use strict';
    app.controller('logoutCtrl', ['api', '$state', 'loginFactory','localStorageService','constants',
...
(function() {
    'use strict';
    app.controller('registerCtrl', ['api', '$state', 'localStorageService', 'constants', 'url',
...
(function () {
    'use strict';
    app.controller('resetForgotPasswordCtrl', ['$state', 'api', 'url', 'constants',
...
(function() {
    'use strict';
    app.controller('usersCtrl', ['api', 'constants', '$uibModal','url', 
